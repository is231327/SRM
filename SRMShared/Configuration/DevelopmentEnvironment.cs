...
public static class DevelopmentEnvironment
{
    private static readonly IReadOnlyDictionary<string, string> ConfigurationKeys =
        ...
        {
            ["SQL_HOST"] = "SqlServer:Host",
            ["SQL_PORT"] = "SqlServer:Port",
            ["SQL_USERNAME"] = "SqlServer:Username",
            ["SQL_PASSWORD"] = "SqlServer:Password",
            ["SQL_AUTH_DATABASE"] = "SqlServer:AuthDatabase",
            ["SQL_CORE_DATABASE"] = "SqlServer:CoreDatabase",
            ...
            ["JWT_ACCESS_TOKEN_LIFETIME_MINUTES"] = "Jwt:AccessTokenLifetimeMinutes",
            ["BOOTSTRAP_ADMIN_USERNAME"] = "BootstrapAdmin:Username",
            ["BOOTSTRAP_ADMIN_EMAIL"] = "BootstrapAdmin:Email",
            ["BOOTSTRAP_ADMIN_PASSWORD"] = "BootstrapAdmin:Password",
            ["BOOTSTRAP_ADMIN_FIRST_NAME"] = "BootstrapAdmin:FirstName",
            ["BOOTSTRAP_ADMIN_LAST_NAME"] = "BootstrapAdmin:LastName",
            ["BOOTSTRAP_ADMIN_PHONE_NUMBER"] = "BootstrapAdmin:PhoneNumber",
            ["BOOTSTRAP_ADMIN_MUST_CHANGE_PASSWORD"] = "BootstrapAdmin:MustChangePassword",
            ["REDMINE_ENABLED"] = "Redmine:Enabled",
            ["REDMINE_HOST"] = "Private:RedmineHost",
            ["REDMINE_PORT"] = "Private:RedminePort",
            ["REDMINE_API_KEY"] = "Redmine:ApiKey",
            ["REDMINE_PROJECT_IDENTIFIER"] = "Redmine:ProjectIdentifier",
            ["REDMINE_TRACKER_ID"] = "Redmine:TrackerId",
            ["REDMINE_STATUS_ID"] = "Redmine:StatusId",
            ...
            ["CORE_HOST"] = "Private:CoreHost",
            ["CORE_PORT"] = "Private:CorePort",
            ["AUTH_HOST"] = "Private:AuthHost",
            ["AUTH_PORT"] = "Private:AuthPort",
            ["AGENT_CLIENT_IDENTIFIER"] = "AgentApi:ClientIdentifier",
            ["AGENT_CLIENT_SECRET"] = "AgentApi:ClientSecret"
        };
