...
public static class DevelopmentEnvironment
{
    private static readonly IReadOnlyDictionary<string, string> ConfigurationKeys =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["SRM_JWT_SIGNING_CERTIFICATE_ENABLED"] = "JwtSigningCertificate:Enabled",
            ["SRM_JWT_SIGNING_CERTIFICATE_THUMBPRINT"] = "JwtSigningCertificate:Thumbprint",
            ["SRM_JWT_SIGNING_CERTIFICATE_STORE"] = "JwtSigningCertificate:Store",
            ["SRM_JWT_SIGNING_CERTIFICATE_STORE_LOCATION"] = "JwtSigningCertificate:StoreLocation",
            ["SRM_JWT_SIGNING_CERTIFICATE_PATH"] = "JwtSigningCertificate:Path",
            ["SRM_JWT_SIGNING_CERTIFICATE_PASSWORD"] = "JwtSigningCertificate:Password",
            ["SRM_JWT_VALIDATION_CERTIFICATE_ENABLED"] = "JwtValidationCertificate:Enabled",
            ["SRM_JWT_VALIDATION_CERTIFICATE_THUMBPRINT"] = "JwtValidationCertificate:Thumbprint",
            ["SRM_JWT_VALIDATION_CERTIFICATE_STORE"] = "JwtValidationCertificate:Store",
            ["SRM_JWT_VALIDATION_CERTIFICATE_STORE_LOCATION"] = "JwtValidationCertificate:StoreLocation",
            ["SRM_JWT_VALIDATION_CERTIFICATE_PATH"] = "JwtValidationCertificate:Path",
            ["SRM_JWT_VALIDATION_CERTIFICATE_PASSWORD"] = "JwtValidationCertificate:Password",
