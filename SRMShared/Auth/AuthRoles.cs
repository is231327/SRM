...
public static class AuthRoles
{
    ...
    public static string GetDescription(AuthRoleType role) => role switch
    {
        ...
        AuthRoleType.CustomerAdmin => "Customer-scoped administrator with customer user management and read-only monitoring access.",
        AuthRoleType.Customer => "Customer-scoped user with read-only monitoring access.",
