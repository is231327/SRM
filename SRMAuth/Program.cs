...
public class Program
{
    ...
    private static string ResolveAuthSqlConnectionString(IConfiguration configuration)
    {
        var connectionString = SqlServerConnectionStringFactory.Resolve(
            configuration,
            connectionStringName: "SrmAuthDatabase",
            connectionStringEnvironmentKey: null,
            databaseEnvironmentKey: "SRM_SQL_AUTH_DATABASE");
        ...
        throw new InvalidOperationException(
            "Missing auth SQL connection configuration. Provide either 'ConnectionStrings:SrmAuthDatabase' or the split SQL settings 'SRM_SQL_HOST', 'SRM_SQL_PORT', 'SRM_SQL_USERNAME', 'MSSQL_SA_PASSWORD', and 'SRM_SQL_AUTH_DATABASE'.");
    }
